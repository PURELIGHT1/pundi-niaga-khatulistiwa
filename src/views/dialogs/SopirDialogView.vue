<template>
  ...
  <template v-else>
    <VForm>
      <CustomTextField
        v-model="sopirStore.form.nama_lengkap.value"
        label="Nama Lengkap"
        ...
        autocomplete="name"
        @update:model-value="(val) => onFieldChange(sopirFieldForm.nama_lengkap, val)"
      />
      <VDivider class="my-1" />

      <CustomTextField
        v-model="sopirStore.form.nomor_hp.value"
        label="Nomor HP"
        ...
        prefix="+62"
        @update:model-value="(val) => onFieldChange(sopirFieldForm.nomor_hp, val)"
      />
      <VDivider class="my-1" />

      <CustomTextField
        v-model="sopirStore.form.nomor_sim.value"
        label="Nomor SIM"
      ...
      <CustomTextField
        v-model="sopirStore.form.asal_pks.value"
        label="Asal PKS"
        placeholder="Maksimal 50 Karakter"
        :prepend-inner-icon="{
      ...
      <CustomTextField
        v-model="sopirStore.form.tujuan_pks.value"
        label="Tujuan PKS"
        placeholder="Maksimal 50 Karakter"
        :prepend-inner-icon="{
      ...
      <CustomTextField
        v-model="sopirStore.form.uang_minyak.value"
        label="Uang Minyak"
        placeholder="500.000"
        :prepend-inner-icon="{
          active: '$account-cash',
        ...
        prefix="Rp"
        @update:model-value="(val) => onFieldChange(sopirFieldForm.uang_minyak, val)"
      />
    </VForm>
  </template>
