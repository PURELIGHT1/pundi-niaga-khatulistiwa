...
<script setup lang="ts">
  ...
  import { type FormattedPKS, StatusPKS } from '@/models/pks-model'
  ...
  function onFieldChange(field: pksFieldForm, value: string | boolean) {
    switch (field) {
      case 'nama':
        namaValidation(value as string, null)
        break
      case 'status':
