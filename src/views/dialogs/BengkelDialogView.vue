  ...
  <template v-else>
    <VForm>
      <CustomTextField v-model="userStore.form.nama_lengkap.value" label="Nama Lengkap"
        ...
        }" autocomplete="name" @update:model-value="(val) => onFieldChange(userFieldForm.nama_lengkap, val)" />
      <VDivider class="my-1" />
      ...
      <CustomTextField v-model="userStore.form.nomor_hp.value" label="Nomor HP" placeholder="8XX-XXXX-XXXX"
        ...
        }" prefix="+62" @update:model-value="(val) => onFieldChange(userFieldForm.nomor_hp, val)" />
      <VDivider class="my-1" />
      ...
      <CustomTextField v-model="userStore.form.email.value" label="Email" placeholder="example@example.com"
        ...
        }" autocomplete="email" @update:model-value="(val) => onFieldChange(userFieldForm.email, val)" />
      <VDivider class="my-1" />
    </VForm>
  </template>
