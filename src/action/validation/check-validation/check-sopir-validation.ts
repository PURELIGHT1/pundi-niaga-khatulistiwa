...
export async function checkSopirValidation(action: string, form: SopirForm): Promise<boolean> {
  const appStore = useAppStore()
  const [namaLengkap, nomorHp, nomorSim, asalPks, tujuanPks, uangMinyak] = await Promise.all([
