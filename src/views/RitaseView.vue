      ...
      <VLayout class="d-flex flex-column mt-8">
        <VForm class="mb-2 d-flex">
          <CustomSelect
            ...
            clearable
            @update:model-value="ritaseStore.inputMonth = null"
          />
          ...
          <VSlideXTransition group>
            <div v-if="ritaseStore.inputYear" class="d-flex align-center">
              ...
              <CustomSelect
                v-model="ritaseStore.inputMonth"
                :items="MONTH_OPTIONS"
                item-title="title"
                item-value="value"
                label="Bulan"
        ...
        <CustomGridLayout grid-template-columns="repeat(3, 1fr)" gap="8px" width="100%">
          <VCard
            v-for="(item, i) in ritaseStore.getSparklineItems"
            :key="i"
            min-width="360px"
            min-height="240px"
          >
          ...
          <VCard
            v-for="(item, i) in ritaseStore.getChartItems"
            :key="i"
            class="pa-2"
          ...
          >
            <VForm class="mb-2 d-flex">
              ...
              <VFadeTransition group>
                ...
                >
                  <CustomSelect
                    ...
                    clearable
                    @update:model-value="item.inputMonth.value = null"
                  />

                  <template v-if="item.inputYear.value">
                    <VDivider class="mx-1" vertical />
                    <CustomSelect
                      v-model="item.inputMonth.value"
                      :items="MONTH_OPTIONS"
                      item-title="title"
                      item-value="value"
                      label="Bulan"
              ...
              <CustomSelect
                v-model="item.chartType.value"
                :items="Object.values(RitaseChartType)"
                label="Tipe Grafik"
                placeholder="Pilih Salah Satu"
                :prepend-inner-icon="{
                  active: '$chart-box',
