...
export function pengeluaranActions() {
  ...
  const createPengeluaran = async (
    ...
    pengeluarans.push({
      id:
        pengeluarans.length === 0
          ? 1
          : pengeluarans[pengeluarans.length - 1].id + 1,
    ...
    appStore.setAlerts(
      "success",
      "Aksi Berhasil",
      "Berhasil Tambah Data Pengeluaran",
    );
  };
  ...
  const updatePengeluaran = async (
    ...
    const index = pengeluarans.findIndex(
      (pengeluaran) => pengeluaran.id === item.id,
    );
    if (index !== -1) {
    ...
    appStore.setAlerts(
      "success",
      "Aksi Berhasil",
      "Berhasil Ubah Data Pengeluaran",
    );
  };
  ...
  const deletePengeluaran = async (form: PengeluaranForm) => {
    ...
    appStore.setAlerts(
      "success",
      "Aksi Berhasil",
      "Berhasil Hapus Data Pengeluaran",
    );
  };
