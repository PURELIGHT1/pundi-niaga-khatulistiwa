<template>
  ...
  <template v-else>
    <VForm>
      <CustomTextField
        v-model="mobilStore.form.merek.value"
        label="Merek"
      ...
      <CustomTextField
        v-model="mobilStore.form.jenis.value"
        label="Jenis"
        placeholder="Maksimal 50 Karakter"
        :prepend-inner-icon="{
          active: '$car-settings',
      ...
      <CustomTextField
        v-model="mobilStore.form.nomor_polisi.value"
        label="Nomor Polisi"
        placeholder="XX YYYY ZZZ"
        :prepend-inner-icon="{
          active: '$car-search',
      ...
      <CustomTextField
        v-model="mobilStore.form.nama.value"
        label="Nama"
        placeholder="Maksimal 50 Karakter"
        :prepend-inner-icon="{
          active: '$car-info',
      ...
      <CustomSelect
        v-model="mobilStore.form.jenis_bbm.value"
        :items="Object.values(MobilJenisBBM)"
        label="Jenis BBM"
      ...
      <CustomSelect
        v-model="mobilStore.form.warna.value"
        :items="itemsWarna"
        label="Warna"
        placeholder="Pilih Salah Satu"
        :prepend-inner-icon="{
      ...
      <CustomTextField
        v-model="mobilStore.form.harga.value"
        label="Harga"
        ...
        prefix="Rp"
        @update:model-value="(val) => onFieldChange(mobilFieldForm.harga, val)"
      />
      <VDivider class="my-1" />

      <CustomTextField
        v-model="mobilStore.form.biaya_pajak.value"
        label="Biaya Pajak"
        ...
        prefix="Rp"
        @update:model-value="(val) => onFieldChange(mobilFieldForm.biaya_pajak, val)"
      />
      <VDivider class="my-1" />

      <CustomDatePicker
        v-model="mobilStore.form.jatuh_tempo_pajak.value"
...
import { type FormattedMobil, MobilJenisBBM, MobilWarna } from '@/models/mobil-model'
